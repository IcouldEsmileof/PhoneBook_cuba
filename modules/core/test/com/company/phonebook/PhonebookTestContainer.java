...
public class PhonebookTestContainer extends TestContainer {

    public PhonebookTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/phonebook/app.properties",
    ...
    public static class Common extends PhonebookTestContainer {

        public static final PhonebookTestContainer.Common INSTANCE = new PhonebookTestContainer.Common();
